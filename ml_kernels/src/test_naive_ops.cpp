...
void test_softmax_v6() {
    ...
    // We need more than 64 elements to test the 8x unrolled loop and the remainder.
    // 72 elements: 64 in the unrolled loop, 8 in the remainder.
    std::vector<float> input = {
        ...
        15.0f, 16.0f, 17.0f, 18.0f, -15.0f, -16.0f, -17.0f, -18.0f,
        2.5f, 3.5f, 4.5f, 5.5f, -2.5f, -3.5f, -4.5f, -5.5f,
        0.01f, 0.02f, 0.03f, 0.04f, -0.01f, -0.02f, -0.03f, -0.04f,
        7.0f, 8.0f, 9.0f, 11.0f, -7.0f, -8.0f, -9.0f, -11.0f
    };
