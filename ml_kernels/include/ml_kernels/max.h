...
// Target: AVX2 (Haswell+)
// Reason: `_mm256_max_ps` has a 4-cycle latency. Simple vector reduction loops
// benefit from aggressive 16x unrolling to fully utilize all 16 YMM registers.
// This perfectly hides instruction latency and shifts bottlenecks directly to L1/L2
// cache bandwidth constraints.
// Expected gain: Better throughput over 8x unroll (max_v3).
namespace ml_kernels {
