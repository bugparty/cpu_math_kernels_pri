...
// ⚡ Thunderbolt: AVX2 Vectorized Softmax with single-FMA exp and 8x unrolling
// Target: AVX2 (Haswell+)
// Reason: Simplifying exp256_ps range reduction by using a single FMA reduces register pressure and instruction count, allowing aggressive 8x unrolling to fully utilize 16 YMM registers and L1 cache bandwidth, shifting bottleneck from instruction latency to cache bandwidth.
