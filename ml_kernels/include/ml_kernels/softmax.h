...
// Target: AVX2 (Haswell+)
// Reason: Aggressive 8x unrolling across all map-reduce phases perfectly hides 4-cycle FMA and max_ps latencies.
// It uses 8 independent accumulator chains which completely saturates execution units and transitions
// the kernel from latency-bound to throughput-bound without spilling YMM registers.
