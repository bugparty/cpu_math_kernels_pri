...
// ⚡ Thunderbolt: AVX2 Softmax Unrolled 8x with single FMA exp256
// Target: AVX2 (Haswell+)
// Reason: Shifts bottleneck from instruction latency to L1/L2 cache bandwidth constraints by fully utilizing all YMM registers and removing redundant FMAs.
// Expected gain: ~10% over softmax_v5 due to higher unrolling and simplified exp256.
