...
// Target: AVX2 (Haswell+)
// Reason: Single FMA for range reduction in exp256 lowers register pressure and reduces latency.
// Lower register pressure enables aggressive 8x unrolling across all passes, effectively hiding latencies.
