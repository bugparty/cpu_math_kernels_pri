...
The `benchmark.yml` workflow automatically runs GEMM benchmarks on every push and pull request.
...
2. **Builds the project**:
   - Compiles `gemm_bench` with optimizations
...
4. Download artifacts:
   ...
   - `gemm-bench-executable`: The compiled binary
...
1. Go to **Actions** tab
2. Select **GEMM Benchmarks** workflow
3. Click **Run workflow** button

### Configuration

Edit `.github/workflows/benchmark.yml` to customize:
